    ...
    photos: [
      {
        ...
        numbers: "8631",
        date: "",
        consist: [{ kind: "traction", label: "VIRM 8631", active: true }],
      },
      {
        series: "amsterdam-photo-0",
        isMain: false,
      ...
      {
        series: "amsterdam-photo-1",
        isMain: true,
        operator: "NS",
        src: "../images/Netherlands/Amsterdam/Amsterdam_NS_VIRM_9525.jpeg",
        alt: "Amsterdam NS VIRM 9525",
        label: "Amsterdam",
        numbers: "9525",
        date: "",
        consist: [{ kind: "traction", label: "VIRM 9525", active: true }],
      },
      {
      ...
      },
      {
        ...
        alt: "Amsterdam NS Vectron 193 733",
        label: "Amsterdam",
        numbers: "193 733",
        date: "",
        consist: [{ kind: "traction", label: "Vectron 193 733", active: true }],
      },
      {
        series: "amsterdam-photo-4",
        isMain: true,
        operator: "Nightjet, NS",
        src: "../images/Netherlands/Amsterdam/Amsterdam_Nightjet.jpeg",
        alt: "Amsterdam Nightjet",
        label: "Amsterdam",
        numbers: "",
        date: "",
        consist: [
          { kind: "traction", label: "Nightjet", active: true },
          { kind: "traction", label: "NS Vectron", active: false },
        ],
      },
      {
  ...
  vienna: {
    ...
    photos: [
      ...
      },
      {
        ...
        alt: "Vienna OEBB Cityjet doubledecker",
        label: "Vienna",
        numbers: "",
        date: "",
      ...
      },
      {
        ...
        alt: "Vienna OEBB Railjet 80-90 729",
        label: "Vienna",
        numbers: "80-90 729",
        date: "",
      ...
      },
      {
        ...
        alt: "Vienna OEBB 1116 182 Army Vectron",
        label: "Vienna",
        numbers: "1116 182",
        date: "",
      ...
      },
      {
        ...
        alt: "Vienna OEBB Cityjet Marchegg wide view",
        label: "Vienna",
        numbers: "",
        date: "",
      ...
      },
      {
        ...
        alt: "Vienna OEBB Cityjet Marchegg",
        label: "Vienna",
        numbers: "",
        date: "",
        consist: [{ kind: "traction", label: "Cityjet Marchegg", active: true }],
      },
      {
        ...
        alt: "Vienna OEBB Cityjet crossing",
        label: "Vienna",
        numbers: "",
        date: "",
      ...
      },
      {
        ...
        alt: "Vienna OEBB Cityjet Glueck",
        label: "Vienna",
        numbers: "",
        date: "",
        consist: [{ kind: "traction", label: "Cityjet", active: true }],
      },
      {
        ...
        alt: "Vienna OEBB Cityjet Stockerau",
        label: "Vienna",
        numbers: "",
        date: "",
  ...
  bratislava: {
    ...
    photos: [
      ...
      },
      {
        ...
        isMain: false,
        operator: "ZSSK",
        src: "../images/Slovakia/Bratislava/Bratislava_ZSSK_263003_Angle.jpeg",
        alt: "Bratislava ZSSK 263 003-6 angle view",
        label: "Bratislava",
        numbers: "263 003-6",
        date: "",
        consist: [{ kind: "traction", label: "263 003-6", active: true }],
      ...
      {
        series: "bratislava-photo-1",
        isMain: true,
        operator: "H-START",
        src: "../images/Slovakia/Bratislava/Bratislava_HSTART_470005.jpeg",
        alt: "Bratislava H-START 470 005",
        label: "Bratislava",
        numbers: "470 005",
        date: "",
      ...
      },
      {
        ...
        isMain: false,
        operator: "H-START",
        src: "../images/Slovakia/Bratislava/Bratislava_HSTART_470005_Front.jpeg",
        alt: "Bratislava H-START 470 005 front view",
        label: "Bratislava",
        numbers: "470 005",
        date: "",
        consist: [{ kind: "traction", label: "470 005", active: true }],
      ...
      {
        series: "bratislava-photo-2",
        isMain: true,
        operator: "OEBB",
        src: "../images/Slovakia/Bratislava/Bratislava_OEBB_1293134.jpeg",
        alt: "Bratislava OEBB 1293 134",
        label: "Bratislava",
        numbers: "1293 134",
        date: "",
      ...
      {
        series: "bratislava-photo-3",
        isMain: true,
        operator: "CD",
        src: "../images/Slovakia/Bratislava/Bratislava_CD_193576.jpeg",
        alt: "Bratislava CD 193 576-6 Bobo",
        label: "Bratislava",
        numbers: "193 576-6",
        date: "",
      ...
      {
        series: "bratislava-photo-4",
        isMain: true,
        operator: "OEBB",
        src: "../images/Slovakia/Bratislava/Bratislava_OEBB_Doubledecker_8633210.jpeg",
        alt: "Bratislava OEBB 86-33 210-4",
        label: "Bratislava",
        numbers: "86-33 210-4",
        date: "",
